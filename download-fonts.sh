...
curl -L "https://github.com/rsms/inter/raw/master/docs/font-files/Inter-Regular.woff2" -o public/fonts/Inter-Regular.woff2

echo "Downloading Inter-Medium.woff2..."
curl -L "https://github.com/rsms/inter/raw/master/docs/font-files/Inter-Medium.woff2" -o public/fonts/Inter-Medium.woff2

echo "Downloading Inter-SemiBold.woff2..."
curl -L "https://github.com/rsms/inter/raw/master/docs/font-files/Inter-SemiBold.woff2" -o public/fonts/Inter-SemiBold.woff2

echo "Downloading Inter-Bold.woff2..."
curl -L "https://github.com/rsms/inter/raw/master/docs/font-files/Inter-Bold.woff2" -o public/fonts/Inter-Bold.woff2
